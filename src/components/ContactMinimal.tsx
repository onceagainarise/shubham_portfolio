      ...
      <Card>
        <div className="text-center space-y-8">
          <p className="text-text-primary">
            Feel free to reach out for opportunities, collaborations, or just to discuss interesting problems.
          </p>
          
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <a href="mailto:ariseonceagain@gmail.com" className="btn-secondary flex items-center justify-center gap-2">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              EMAIL
            </a>
            <a href="https://github.com/onceagainarise" className="btn-secondary flex items-center justify-center gap-2">
            ...
            <a href="https://www.linkedin.com/in/shubham-3793a9257/" className="btn-secondary flex items-center justify-center gap-2">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="pt-8 border-t border-border">
            <div className="inline-block bg-white text-black px-4 py-2">
              <Meta>Available for full-time opportunities and consulting projects</Meta>
            </div>
          </div>
        </div>
      </Card>
